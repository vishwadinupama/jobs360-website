import { Send, Bookmark, Bell, UserRound } from "lucide-react";
  ...
  return (
    <div className="flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-[#f8fbff] shadow-sm">
      <div
        ...
        style={{
          backgroundImage:
            "url('/login/jobseeker/jobseeker-benefits-banner.webp')",
        }}
      >
        <div className="absolute inset-x-0 top-0 p-5 sm:p-6">
          ...
          <p className="mt-1 max-w-[180px] text-xs leading-5 text-slate-500">
            Sign in to unlock tools that help you find the right opportunities
            faster.
          </p>
        </div>
      </div>
